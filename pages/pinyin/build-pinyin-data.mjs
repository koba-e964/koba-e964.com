...
function usage() {
  return [
    "Usage: node pages/pinyin/build-pinyin-data.mjs [Unihan_Readings.txt] [Unihan_Variants.txt]",
    "",
    `Default readings: ${DEFAULT_READINGS}`,
...
async function main() {
  ...
  const header = [
    "/* Generated by build-pinyin-data.mjs from Unicode UCD 17.0.0 Unihan data.",
  ...
  console.log(`Wrote ${compact.length} compact entries to ${path.relative(process.cwd(), OUTPUT_PATH)}`);
}
