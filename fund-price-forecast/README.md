...
- `/fund-price-forecast/`
  - 対応ファンド一覧
- `/fund-price-forecast/253266/`
  - 個別ファンドの詳細ページ

## フロント

- [site/index.html](/Users/kobas-mac/srcview/koba-e964.com/fund-price-forecast/site/index.html)
- [site/253266/index.html](/Users/kobas-mac/srcview/koba-e964.com/fund-price-forecast/site/253266/index.html)
...
別ファンドを増やすときは `site/<fund_code>/index.html` を追加し、一覧ページのリンクを増やします。
...
- `http://localhost:8000/fund-price-forecast/site/`
  - 開発中の一覧ページ
- `http://localhost:8000/fund-price-forecast/site/253266/`
  - 開発中の個別価格ページ
...
- `http://localhost:8000/fund-price-forecast/`
  - 本番の一覧ページ相当
- `http://localhost:8000/fund-price-forecast/253266/`
  - 本番の個別価格ページ相当
...
現在は raw の `S&P 500` と `TTM` を使う `v3` で近似しています。
