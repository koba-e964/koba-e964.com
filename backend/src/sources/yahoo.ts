...
export function parseYahooSp500Html(html: string, sourceUrl: string, fetchedAt: string): MarketIndexDailyRecord {
...
export async function fetchYahooSp500(sourceUrl: string): Promise<MarketIndexDailyRecord> {
